...
const Facilities = props => (
  <div className="procedure-outer">
    <div className="procedure-wrapper">
      <h1>Facilities</h1>
      <p>
        The campus of NIT Jamshedpur is situated at the heart of Lucknow city providing fast connectivity to railway and airport situated at a distance less than 20 kilometers.
      </p>
