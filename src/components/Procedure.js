...
import ExamplePdf from '../assets/team22/PLACEMENT2023_2024.pdf';
import job from '../assets/team22/JAF_2023-24.pdf';
...
const Procedure = props => (
  <div className="procedure-outer">
    <div className="procedure-wrapper">
      ...
      <ul className="custom-list">
        <li>
          ...
          <a
        href={ExamplePdf}
        download="Placement Brochure 2023-2024.pdf"
        target="_blank"
        rel="noreferrer"
      > link
      </a>
        </li>
        <li>JOB ANNOUNCEMENT FORM (Session 2023-24)
        <a
        href={job}
        download="JOB ANNOUNCEMENT FORM "
        target="_blank"
        rel="noreferrer"
      > link
      </a>
    ...
    <div className="procedure-wrapper">
      ...
      <ul className="custom-list">
        <li>
          The Training and Placement Office,  NIT JSR sends invitations alongwith
        ...
        <li>
          ...
          sent by email to Training and Placement Office, NIT JSR (
          <a href="mailto:placements@nitjsr.ac.in">placements@nitjsr.ac.in</a>
          ).
        </li>
        <li>
        ...
        <li>
          Training and Placement Office, NITJSR allots date(s) to an organization
          for campus placements. The organization confirms the date(s) to
          Training and Placement Office, NITJSR.
        </li>
        <li>
        ...
        <li>
          Training and Placement Office, NITJSR also coordinates the signing of
      ...
      <div className="sub-part">
        ...
        <h2>Internship</h2>
        <p>
          M.C.A. 2nd year students are eligible for <strong>2 months</strong>{" "}
          summer internship The student will join the company in May/June 2024
          as an intern for a period of 2 months.
        </p>
        <p>
          M.C.A. 4th year students are eligible for <strong>6 months</strong>{" "}
          internship. The student will join the company in January 2024 as an
          intern for a period of 6 months and complete their 6th semester
